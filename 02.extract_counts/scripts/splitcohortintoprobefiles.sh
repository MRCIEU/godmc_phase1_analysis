...
cd /panfs/panasas01/shared-godmc/meta-analysis_2017/inputfiles
...
#mkdir -p $cohort
#cd $cohort
#awk 'BEGIN {FS = "\t"}; {print > ("'$user'_'${cohort}.'"$2".txt")}' </panfs/panasas01/shared-godmc/meta-analysis_2017/inputfiles/${user}\_${cohort}.gwama.formatted.txt

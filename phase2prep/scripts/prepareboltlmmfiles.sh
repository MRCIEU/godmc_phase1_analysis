...
set -e
source /panfs/panasas01/sscm/epzjlm/repo/godmc/config
...
#Rscript /panfs/panasas01/sscm/epzjlm/repo/godmc/resources/methylation/extractprobesubsets.R \
#	${betas} \
#	${covariates_combined}.txt \
#	${#cpgs[@]} \
#	${methylation_processed_dir} \
#	${bfile}.fam \
#	${covariates_combined}.boltlmm

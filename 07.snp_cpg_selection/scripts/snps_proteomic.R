...
proteomic <- format_proteomic_qtls(proteomic_qtls)
snpid <- ucsc_get_position(unique(proteomic$SNP))
proteomic <- merge(proteomic, snpid)

save(proteomic, file="../data/snps_proteomic.rdata")
